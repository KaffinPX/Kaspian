...
export default function SendDrawer() {
  ...
  const [inputs] = useState<CustomInput[]>(
  ...
  const initiateSend = useCallback(() => {
    request("account:create", [outputs, fee, inputs])
      .then((transactions) => {
          ...
          <div className="flex flex-col p-4 pb-0 items-center gap-3">
            ...
            <TooltipProvider>
              <TabsComponent
                ...
                onValueChange={(value) =>
                  setTransactionSpeed(value as "slow" | "regular" | "fast")
                }
              ...
              >
                <TabsList>
                  <Tooltip>
                    ...
                    <TooltipContent>{i18n.getMessage("slow")}</TooltipContent>
                  </Tooltip>
                  <Tooltip>
                    <TooltipTrigger>
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>{i18n.getMessage("fast")}</TooltipContent>
                  </Tooltip>
                </TabsList>
              </TabsComponent>
            </TooltipProvider>
